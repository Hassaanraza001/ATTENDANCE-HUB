...
void processSmsCommand(String command) {
    ...
    // Check if the serial buffer is empty. If it is, all commands have been processed.
    if(Serial.peek() == -1){ 
       delay(2000); // Wait a bit before sending final confirmation
       Serial.println("All SMS processed.");
       lcd.clear();
